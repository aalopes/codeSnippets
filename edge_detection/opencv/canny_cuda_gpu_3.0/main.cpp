...
int main( )
{
    ...
    Mat src_host;
    cuda::GpuMat src_device;
    cuda::GpuMat gray_device, edge_device;
    ...
    cuda::cvtColor(src_device, gray_device, CV_BGR2GRAY);
    ...
    bool useL2grad     = false;

    Ptr<cuda::CannyEdgeDetector> canny = cv::cuda::createCannyEdgeDetector(low_thresh, high_thresh, apperture_size, useL2grad);

    // detect edges
    canny->detect( gray_device, edge_device);
